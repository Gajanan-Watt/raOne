...
export default function Services() {
    ...
    const [info, useInfo] = useState([
        ...
        },
        {
            ...
            bodyText: "Digital design and content: Creating visually appealing and compelling online materials. This includes graphics, videos, and written content to engage audiences, deliver messages effectively, and enhance user experiences.",
        ...
        },
        {
            ...
            bodyText: "Digital management: coordinating and optimising online strategies, including social media, websites, and campaigns. Leveraging technology and data for effective engagement and achieving business goals."
        },
        {
            title: "Social Media Strategy",
            bodyText: "Social media strategy: Planning and executing a targeted approach to maximise brand presence. Identifying goals, selecting platforms, creating engaging content, and analysing performance to foster meaningful connections with the audience.",
        ...
        },
        {
            ...
            bodyText: "Location-based content delivers personalised digital experiences by tailoring information to users' geographical locations. Through geotags and location data, businesses offer location-specific offers, recommendations, and relevant updates, fostering stronger connections with their audience. This approach enhances user engagement, drives foot traffic to physical locations, and boosts overall customer satisfaction, as people feel more connected to the content and services that cater to their local needs."
        },
        {
            title: "Mass Marketing Videos",
            bodyText: "Mass marketing videos: Broad-reaching, one-size-fits-all promotional content. Aimed at a large audience, these videos convey a unified message to raise brand awareness and drive consumer interest.",
        ...
        },
        {
            ...
            bodyText: "Custom data analysis: Personalised data examination tailored to a business's unique requirements. Utilising advanced techniques to extract actionable insights for informed decision-making and achieving strategic objectives.",
        ...
        },
        {
            ...
            bodyText: "Data consultant: Expert advisor guiding businesses on data-related matters. They assess data strategies, offer insights, and implement solutions to optimise processes and achieve organisational goals.",
        ...
        {
            title: "BI analyst",
            bodyText: "BI analyst: Data expert analyzing information to aid business decisions. Utilizing tools for reports, dashboards, and visualizations, they uncover insights to optimize processes and drive organizational performance.",
